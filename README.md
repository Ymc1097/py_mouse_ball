...
The sensing point of Mouse 1 on the ball has a position vector ${\boldsymbol{p}}_{m1}$. When the ball rotates with angular velocity vector $\boldsymbol{\omega}$, the circumferential speed ${\boldsymbol{\upsilon}}_{m1}$ of the ball at that point is:
